...
let carros = [
  { nombre: "tsuu", color: "rojo", dueno: "yair" },
  { nombre: "vw", color: "amarillo", dueno: "jose" },
];
...
const compararNacionalidad = (usersArray, nation) => {
  let nuevoArray = usersArray.filter((user) => user.nat === nation);
  return nuevoArray;
};

let nacionalidad = compararNacionalidad(users, "FI");
console.log(nacionalidad);

//

//EJERCICIO2
// var carrrosFiltro = carros.filter(function(colores){
//   return propietario.color=="amarillo"

// })
// console.log(carrrosFiltro)

const carroColor = (color)=>{
  let nuevoColor = carros.filter((color) => color.´p
}
